        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <motion.div variants={itemVariants} className="flex gap-4">
              <a href="https://www.youtube.com/@crosslinksai" target='__blank' className="w-8 h-8 rounded-full bg-[#14242D] flex items-center justify-center text-white hover:bg-[#ffb950] transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" /></svg>
              </a>
              <a href="https://www.linkedin.com/in/piyushbharoliya/" target='__blank' className="w-8 h-8 rounded-full bg-[#14242D] flex items-center justify-center text-white hover:bg-[#ffb950] transition-colors">
              ...
              <a href="https://www.instagram.com/crosslinks.ai/" target='__blank' className="w-8 h-8 rounded-full bg-[#14242D] flex items-center justify-center text-white hover:bg-[#ffb950] transition-colors">
