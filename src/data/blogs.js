...

{
  ...
  title: 'How Small Businesses Are Automating 70% of Their Work with AI',
  excerpt:
    'From WhatsApp replies to invoice generation — small teams are quietly automating most of their operations using simple AI workflows.',
  ...
  publishedBy: 'Crosslinks AI',
  metrics: [
    { value: '70%', label: 'Work Automated', color: '#ffb950', sub: 'across operations' },
    { value: '3x', label: 'Faster Output', color: '#7dd3fc', sub: 'within weeks' },
    { value: '0', label: 'New Hires', color: '#f97316', sub: 'required' },
  ],
  cardStats: [
    { value: '70%', label: 'automated' },
    { value: '3x', label: 'speed' },
    { value: '0', label: 'new hires' },
  ],
  outcomes: [
    { icon: '↓', text: 'Reduced workload' },
  ...
  sections: [
    {
      label: '01 — Overview',
      blocks: [
        { type: 'paragraph', text: 'AI is no longer limited to large enterprises. Small businesses are now leveraging simple tools to automate repetitive tasks.' },
      ],
    },
  ],
  cta: {
    heading: 'Want to automate your business?',
    sub: 'Start with an AI audit today.',
    button: 'Get Started',
  },
},

{
  slug: 'ai-in-marketing-2026',
  title: 'AI in Marketing: What’s Actually Working in 2026',
  excerpt:
    'Not all AI strategies work. Here’s what top-performing companies are actually using in marketing today.',
  ...
  publishedBy: 'Crosslinks AI',
  metrics: [
    { value: '5x', label: 'ROI Increase', color: '#86efac', sub: 'with AI campaigns' },
    { value: '60%', label: 'Cost Cut', color: '#ffb950', sub: 'in ad creation' },
  ],
  cardStats: [
    { value: '5x', label: 'ROI' },
  ...
  outcomes: [
    ...
    { icon: '↓', text: 'Lower ad costs' },
  ],
  sections: [
    {
      label: '01 — Key Trends',
      blocks: [
        { type: 'paragraph', text: 'AI-generated creatives, automated targeting, and real-time optimization are dominating modern marketing.' },
      ],
    },
  ],
  cta: {
    heading: 'Upgrade your marketing with AI',
    sub: 'Learn what works and what doesn’t.',
    button: 'Explore More',
  },
},

{
  slug: 'future-of-ai-teams',
  title: 'The Future of AI Teams: Why Every Company Will Train Internally',
  excerpt:
    'Outsourcing AI is fading. Companies are now building internal AI-first teams to stay competitive.',
  coverImage: '/blog4.png',
  category: 'Future',
  tags: ['AI Teams', 'Workforce'],
  clientName: 'Research',
  clientLogo: '/logo.png',
  clientLocation: 'Global',
  publishedBy: 'Crosslinks AI',
  metrics: [
    { value: '90%', label: 'Companies Adopting', color: '#7dd3fc', sub: 'AI internally' },
    { value: '2x', label: 'Productivity', color: '#f97316', sub: 'increase' },
  ],
  cardStats: [
  ...
  outcomes: [
    { icon: '◎', text: 'Internal AI teams' },
    { icon: '↑', text: 'Faster growth' },
  ],
  sections: [
    {
      label: '01 — Shift in Strategy',
      blocks: [
        { type: 'paragraph', text: 'Companies are moving away from outsourcing and investing in internal AI capabilities.' },
      ],
    },
  ],
  cta: {
    heading: 'Build your AI-first team',
    sub: 'Start training today.',
    button: 'Get Training',
  },
},
