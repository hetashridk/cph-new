        ...
        {featured && (
          ...
          >
            ...
            <Link to={`/blog/${featured.slug}`} className="group block">
              <div className="flex flex-col lg:flex-row lg:items-start rounded-3xl overflow-hidden border border-[#14242D]/8 hover:border-[#ffb950]/60 transition-all duration-500 shadow-[0_8px_40px_rgba(20,36,45,0.06)] hover:shadow-[0_16px_60px_rgba(255,185,80,0.15)]">

                {/* Cover — natural image height drives the card height */}
                <div className="relative lg:w-[55%] shrink-0">
                  <img src={featured.coverImage} alt={featured.title} className="w-full h-auto block" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent pointer-events-none" />
                </div>

                {/* Content — clipped to image height */}
                <div className="flex flex-col justify-between p-4 md:p-6 bg-white lg:flex-1 lg:self-stretch overflow-hidden">
                  ...
                  <div className="mt-10 flex items-center justify-between border-t border-[#14242D]/6 pt-1">
